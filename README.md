...
[![License](https://img.shields.io/badge/License-BSD--3--Clause--Clear-ffd200?style=for-the-badge)](./LICENSE)
...
- [Overview](#overview)
  - [What makes Macetz different](#what-makes-macetz-different)
- [Live Deployment](#live-deployment)
- [Product Demo (GIF Walkthrough)](#product-demo-gif-walkthrough)
  - [1. Browse the Registry — every onchain pair, badged](#1-browse-the-registry--every-onchain-pair-badged)
  - [2. Faucet — all 7 official cTokenMocks in one click](#2-faucet--all-7-official-ctokenmocks-in-one-click)
  - [3. Shield — ERC-20 → confidential ERC-7984](#3-shield--erc-20--confidential-erc-7984)
  - [4. Decrypt — one EIP-712 signature, your balance only](#4-decrypt--one-eip-712-signature-your-balance-only)
  - [5. Unshield — the honest two-phase unwrap](#5-unshield--the-honest-two-phase-unwrap)
  - [6. Universal Decrypt — ANY ERC-7984, not just registry pairs](#6-universal-decrypt--any-erc-7984-not-just-registry-pairs)
  - [7. Add a Pair — extensibility without redeploying](#7-add-a-pair--extensibility-without-redeploying)
  - [8. Confidential Distribution — payroll nobody can read](#8-confidential-distribution--payroll-nobody-can-read)
- [Dual-Network Support](#dual-network-support)
  - [Network switching](#network-switching)
  - [Mainnet real-funds safety](#mainnet-real-funds-safety)
- [Registry Integrity Detection](#registry-integrity-detection)
  - [What is checked (per pair, on every registry load)](#what-is-checked-per-pair-on-every-registry-load)
  - [The Official/Mock distinction matters](#the-officialmock-distinction-matters)
  - [Visibility in the UI](#visibility-in-the-ui)
- [Features](#features)
  - [Browse the Registry](#browse-the-registry)
  - [Developer-Friendly Onboarding — Guided Tutorial + In-App Docs](#developer-friendly-onboarding--guided-tutorial--in-app-docs)
  - [SEO-Optimized & Discoverable](#seo-optimized--discoverable)
  - [Confidential Distribution (TokenOps — Sepolia)](#confidential-distribution-tokenops--sepolia)
  - [Wrap (ERC-20 → ERC-7984)](#wrap-erc-20--erc-7984)
  - [Unwrap (ERC-7984 → ERC-20)](#unwrap-erc-7984--erc-20)
  - [Decrypt Balances (Universal)](#decrypt-balances-universal)
...
- [How the Registry is Sourced](#how-the-registry-is-sourced)
  - [1. Primary: Onchain Wrappers Registry](#1-primary-onchain-wrappers-registry)
  - [2. Secondary: Local Config](#2-secondary-local-config)
  - [Registry Merge Logic](#registry-merge-logic)
- [How to Add a New ERC-20 ↔ ERC-7984 Pair](#how-to-add-a-new-erc-20--erc-7984-pair)
  - [Path A — Official Registration (Recommended for Production)](#path-a--official-registration-recommended-for-production)
  - [Path B — Local Config (For Dev / Prototyping)](#path-b--local-config-for-dev--prototyping)
  - [Path C — In-App Admin UI (Interactive extensibility demo)](#path-c--in-app-admin-ui-interactive-extensibility-demo)
  - [Path D — Deploy your own pair (dev-guide/)](#path-d--deploy-your-own-pair-dev-guide)
- [Official Sepolia cTokenMocks](#official-sepolia-ctokenmocks)
- [Technical Deep Dive](#technical-deep-dive)
  - [Wrap Flow (ERC-20 → ERC-7984)](#wrap-flow-erc-20--erc-7984)
  - [Unwrap Flow (ERC-7984 → ERC-20)](#unwrap-flow-erc-7984--erc-20)
  - [EIP-712 User-Decryption Flow](#eip-712-user-decryption-flow)
...
- [Deployment](#deployment)
  ...
  - [Environment Variables (Vercel Dashboard)](#environment-variables-vercel-dashboard)
- [Environment Variables](#environment-variables)
- [Special Bounty Track — Confidential Payroll (TokenOps)](#special-bounty-track--confidential-payroll-tokenops)
  - [Use case](#use-case)
  - [Smart contract layer (for judges)](#smart-contract-layer-for-judges)
  - [Distribute tab flows (Sepolia only)](#distribute-tab-flows-sepolia-only)
  - [TokenOps SDK wiring](#tokenops-sdk-wiring)
- [Bounty Submission Checklist (Wrappers Registry Track)](#bounty-submission-checklist-wrappers-registry-track)
- [Verified On-Chain Evidence (Sepolia)](#verified-on-chain-evidence-sepolia)
